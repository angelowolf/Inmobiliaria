        ...
        <display:table name="servicioLista" pagesize="10" requestURI="${listar}" uid="row">
            ...
            <display:column title="Funciones">
                <s:form action="editar"  style="display:inline-block;">
                    ...
                    <s:submit type="button" data-id="%{#attr.row.idServicio}" title="Eliminar" theme="simple" cssClass="btn btn-danger" data-toggle="modal" data-target="#modal-delete"><i class='fa fa-trash'></i></s:submit>
            </display:column>
        </display:table>
